...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  var _editProduct =
      Product(id: null as String, title: '', price: 0, description: '', imageUrl: '');
  bool _isInit = true;
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  onFieldSubmitted: (_) {
                    FocusScope.of(context).requestFocus(_urlImageFocusNode);
                  },
                  validator: (val) {
                    if (val!.isEmpty) {
                ...
                Row(
                  ...
                  children: [
                    Container(
                        ...
                        child: _urlImageController.text.length == 0
                            ? Center(child: Text('No image'))
                            : FadeInImage.assetNetwork(
                                placeholder: 'assets/images/circle.gif',
                                image: _urlImageController.text,
                                fit: BoxFit.cover,
                              )),
                    Expanded(
                      child: TextFormField(
